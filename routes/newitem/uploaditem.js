...
function upload_three(cbkey, deferred){
    //要上传的空间
    var bucket = 'suteng';
    //上传到七牛后保存的文件名
    ...
    //要上传文件的本地路径
    var filePath = path.join(__dirname, '../../public/pano/' + cbkey + '.jpg');
...
function uptoken(bucket, key) {
    ...
    putPolicy.callbackUrl = 'http://120.76.27.228/uploadsitem/nodeupcb';
