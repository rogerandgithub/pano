                        ...
                        db.Maps.findOne({
                            ...
                            db.Scenes.findAll(map).then(function(romaing){
                                ...
                                db.Links.findAll({
                                    ...
                                    console.log(JSON.stringify(links_object));
        ...
        switch(sharetype){
            case 0:  //未过期默认跟随场景
                ...
                if(groups[0].scenes[0].type >= 5&&groups[0].scenes[0].type <= 7){
                    result.shareiconKey = 'http://wx.sz-sti.com/pano/'+groups[0].scenes[0].key+'.tiles/thumb.jpg';
                }else if(groups[0].scenes[0].type == -1){
                    result.shareiconKey = 'http://wx.sz-sti.com/pano/pano2T/'+groups[0].scenes[0].key+'/thumb.jpg';
                }else{
