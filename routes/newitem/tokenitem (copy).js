...
function queueup(){
    ...
    utils.client.get('upNum', function(err, value){
        ...
        db.Missions.findAll({
            ...
            if(toLen > 3){
                missions.splice(3-value,toLen-3);
            }
            // if(missions.length > 8){
            //     missions.splice(8,missions.length-8);
            // }
            ...
            db.Missions.update({//推进了队列中的任务状态值改成1
                status: 1
            },{
                where: {
                    id: {$in: arr}
...
function uptoken(bucket, key) {
    ...
    putPolicy.callbackUrl = 'http://wx.sz-sti.com/tokenitem/nodeupcb';
