...
!function ($, moment) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker"><div class="calendarbox">\
                    <div class="datepicker-head"><span>上传时间:</span><span class="rangeDate1"></span><span class="date-separator">至</span><span type="text" class="rangeDate2"></span></div>\
                    <p class="calendartitle">From (开始日期)：</p><div class="calendar right"></div>\
                    <p class="calendartitle">To (结束日期)：</p><div class="calendar left"></div>\
                    <div class="ranges">\
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            this.applyClass = 'radius-btn';
            this.cancelClass = 'radius-btn';
        ...
        updateInputText: function() {
            this.element.find('.rangeData1').html(this.startDate.format(this.format));
            search.selected.start = this.startDate.format(this.format);
            this.element.find('.rangeData2').html(this.endDate.format(this.format));
            search.selected.end = this.endDate.format(this.format);
        },
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            $('.rangeDate1').html(this.startDate.format('YYYY-MM-DD'));
            $('.rangeDate2').html(this.endDate.format('YYYY-MM-DD'));
            ...
            if(!this.today) 
                this.today = $.extend({}, this.endDate); 
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    if ((minDate && calendar[row][col].isBefore(minDate)) || (maxDate && calendar[row][col].isAfter(maxDate)) || calendar[row][col] > this.today) {
                        cname = ' off disabled ';
