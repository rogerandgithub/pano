...
var Qiniu_Cookie = {
    key:function(name){
        return base64encode(utf16to8(name));
    },
...
if (typeof FileReader == "undefined") {
    ...
    try{
        ...
        alert("您的浏览器版本太老了，请升级浏览器。360浏览器请切换到极速模式。");
    }
}
...
(function Qiniu() {
    ...
    // var Qiniu_UploadUrl = window.highupload?"/uploadsitem/":"http://up.qiniu.com";
    ...
    //普通上传
    var Qiniu_upload = function(f, key, userid) {
        var xhr = new XMLHttpRequest();
        xhr.open('POST', window.highupload?"/uploadsitem/":"http://up.qiniu.com", true);
    ...
    //上传base64格式图片
    var Qiniu_upload_base64 = function(f, key) {
    ...
    window.Q = window.Qiniu = {
        Upload: Qiniu_upload,
        Upload_base64: Qiniu_upload_base64,
        Stop: function() {
            if (Qiniu_xhring) {
                Qiniu_xhring.abort();
            }
